  ...
  <div class="layout">
    <header class="flex absolute top-0 z-50 w-full">
      <div class="mx-4 md:mx-16 my-4 md:my-8 flex w-full align-middle">
        ...
        <g-link to="/"><g-image class="w-2/3" src="~/assets/logo.png"></g-image></g-link>
      ...
      <div  v-click-outside="closeMenu" class="bg-red-700 fixed top-0 right-0 md:right-auto md:top-auto md:relative h-screen md:h-auto flex w-4/5 md:w-auto transform  transition-all duration-500 ease-in-out" :class="{'translate-x-0': isOpen, 'translate-x-full': !isOpen}">
